# Copyright (c) 2025 Akanksha Chaudhari
...
def wire_missing_salam_tick_engines(system):
    ...
    Older generated SALAM configs (vision pipelines) omit explicit
    SALAMTickEngine wiring. gem5 cannot resolve those proxies at instantiate.
    """
